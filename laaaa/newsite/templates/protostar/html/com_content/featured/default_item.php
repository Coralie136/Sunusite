...
<div class="catItemView groupLeading homepage">
	...
	<div class="catItemHeader">
		<h3 class="catItemTitle">
			<div class="catItemExtraFields">
				<img src="templates/protostar/images/template/icon<?php echo $this->item->rowcount;?>.png" alt="Icon"/> 
			...
			<?php else : ?>
				<?php 
				$pieces = explode(" ", $this->escape($this->item->title));
