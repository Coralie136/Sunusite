...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text == JText::_('JLIB_HTML_START'))
	{
		return '<li><span class="pagenav">'.JText::_('JLIB_HTML_START').'</span></li>';
	}

	// Check for "Prev" item
	if ($item->text == JText::_('JPREV'))
	{
		return '<li><span class="pagenav">'.JText::_('JPREV').'</span></li>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		return '<li><span class="pagenav">'.JText::_('JNEXT').'</span></li>';
	}

	// Check for "End" item
	if ($item->text == JText::_('JLIB_HTML_END'))
	{
		return '<li><span class="pagenav">'.JText::_('JLIB_HTML_END').'</span></li>';
	}
