						...
						<div class="rt-block">
							<div class="custom">
								<div class="custom">
									...
									<a href="index.php/recrutement" class="view">voir détails</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="rt-grid-8 rt-alpha">
							...
							<div class="rt-block">
								<p class="copyright">
									...
									<span>Bénin | Burkina Faso | Cameroun | Centrafrique | Côte d'Ivoire | Gabon | Ghana | Guinée | Libéria | Mali | Niger | Nigéria | Sénégal | Togo</span>
								</p>
							</div>
						</div>
						<div class="rt-grid-4 rt-omega">
							<div class="rt-block">
								<!-- ul class="menu-social">
									<li id="item-301">
										<a href="#"><span><img src="images/twitter.png" alt="twitter"/><span class="image-title">twitter</span></span></a>
									</li>
									<li id="item-302">
										<a href="#"><span><img src="images/facebook.png" alt="facebook"/><span class="image-title">facebook</span> </span></a>
									</li>
									<li id="item-303">
										<a href="#"><span><img src="images/flickr.png" alt="flickr"/><span class="image-title">flickr</span> </span></a>
									</li>
									<li id="item-304">
										<a href="#"><span><img src="images/rss.png" alt="rss"/><span class="image-title">rss</span> </span></a>
									</li>
									<li id="item-305">
										<a href="#"><span><img src="images/plus.png" alt="plus"/><span class="image-title">plus</span> </span></a>
									</li>
								</ul--> 
							</div>
						</div>
