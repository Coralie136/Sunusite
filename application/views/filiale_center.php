                ...
                <?php foreach($filiales as $filiale): ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <a href="#">
                                <h3><?php echo $filiale->titre_fr ?></h3>
                            </a>
                            <?php echo $filiale->detail_fr ?>
                        </div>
                        <?php if(!empty($filiale->image)): ?>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="single-page">
                                <div class="page-img elec-page">
                                    <img src="<?php echo site_url('/upload/filiale/'.$filiale->image) ?>" alt="<?php echo $filiale->titre_fr; ?>" width="100%" >
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="row row-eq-height">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 single-well">
                            ...
                            <?php echo $filiale->info_juridique_fr ?>
                        </div>
                    </div>
                    <div class="row row-eq-height">
                        <div class="col-md-6 col-sm-12 col-xs-12 single-well">
                            ...
                            <?php echo $filiale->direction_general_fr ?>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12 single-well">
                            <a href="#">
                                <h6>Actionnariat</h6>
                            </a>
                            <?php echo $filiale->actionnariat_fr ?>
                        </div>
                    </div>
                    <div class="row row-eq-height">
                        <div class="col-md-6 col-sm-12 col-xs-12 single-well">
                            ...
                            <?php echo $filiale->conseil_admin_fr ?>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12 single-well">
                            <a href="#">
                                <h6>Produits Commercialisés</h6>
                            </a>
                            <?php echo $filiale->produit_fr ?>
                        </div>
                    </div>
                <?php }else{
                        ?>
