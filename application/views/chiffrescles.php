...
<div class="welcome-area mg-50">
    <div class="container">
        ...
        <div class="row">
            <!-- <img src="<?php echo site_url(); ?>upload/chiffre_cle/CJiffres_Clés.jpg" alt="Chiffres Clés Consolidés"> -->
            <img src="<?php echo (!empty($images[1]->fichier_image)?site_url('upload/chiffre_cle/').$images[1]->fichier_image:site_url('upload/chiffre_cle/CJiffres_Clés.jpg')); ?>" alt="Chiffres Clés Consolidés">
        </div>
    </div>
</div>
