                        ...
                        <div class="col-md-12" id="profil">
                            ...
                            <div class="layer-1-3">
                                <form action="<?php echo site_url('profil') ?>" method="POST" accept-charset="utf-8" id="profilForm" autocomplete='off'>
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" name="telephone" placeholder="Numéro de téléphone" required>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="layer-1-3">
                            <form action="<?php echo site_url('profil') ?>" method="POST" accept-charset="utf-8" id="profilForm" autocomplete='off'>
                                ...
                                <div class="form-group" id="lassurable1">
                                    <select name="id_assurable[]" class="form-control ignore mul" multiple data-placeholder="<?php echo lang('precieux'); ?>" required>
                    ...
                    ?>
                        <div class="content-actu col-md-12 col-sm-12">
                            <div class="col-lg-5 col-md-12">
                                ...
                                <p><strong><?php echo $actu->titre_article; ?></strong><?php echo $this->fonctions->truncate($actu->texte_article, 275, '') ; ?></p>
                                <br/>
