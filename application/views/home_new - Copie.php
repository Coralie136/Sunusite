                    ...
                    <div id="actu_caroussel" class=" col-md-12 col-sm-12" style="padding-left: 0;padding-right: 0; background: #C6183C; height: 100%;">
                        <div class="content-actu col-md-12 col-sm-12">
                            <div class="col-lg-5 col-md-12">
                                <img src="<?php echo site_url('assets/images/actu.png'); ?>" class="img-responsive hidden-lg hidden-xs" style="float: right; margin-left: 15px; margin-bottom: 15px; width: 50%;" alt="">
                                <p><strong>GABON : LE GROUPE SUNU DÉVOILE SES AMBITIONS POUR LE GABON</strong><br/>Présents à Libreville dans le cadre des conseils des comptes, les membres du comité de direction du Groupe SUNU : M. Pathé DIONE, PDG, Messieurs Mohamed BAH et Joël AMOUSSOU, Directeurs Généraux Délégués ont rencontré partenaires et clients locaux le 22 mars 2018.[...]</p>
                                <br/>
                                <a href="http://www.sunu-group.com/index.php/actualites/348-after-gabon2" title="" class="plus-btn left-btn"><?php echo lang('plus'); ?></a>
                            </div>
                            <div class="col-lg-7 col-md-12 col-sm-6 content-img hidden-sm hidden-xs hidden-md">
                                <img src="<?php echo site_url('assets/images/actu.png'); ?>" class="img-responsive" alt="">
                            </div>
                        </div>
                        <div class="content-actu col-md-12 col-sm-12">
                            <div class="col-lg-5 col-md-12">
                                <img src="<?php echo site_url('assets/images/actu2.png'); ?>" class="img-responsive hidden-lg hidden-xs" style="float: right; margin-left: 15px; margin-bottom: 15px; width: 50%;" alt="">
                                <p><strong>CÔTE D'IVOIRE: SUNU ASSURANCES VIE CI OSE AVEC LES FEMMES FEEF</strong><br/>Les 16 et 17 mars 2018, SUNU Assurances Vie CI a « Osé » en étant le partenaire de la 5ème édition du Forum de l’Emploi et de l’Entreprenariat Féminin « FEEF2018 ». Deux jours de festivités qui ont permis aux femmes venues de différents horizons de partager leurs [...]</p>
                                <br/>
                                <a href="http://www.sunu-group.com/index.php/actualites/344-feef-texte" title="" class="plus-btn left-btn"><?php echo lang('plus'); ?></a>
                            </div>
                            <div class="col-lg-7 col-md-12 col-sm-6 content-img hidden-sm hidden-xs hidden-md">
                                <img src="<?php echo site_url('assets/images/actu2.png'); ?>" class="img-responsive" alt="">
                            </div>
                        </div>
                    </div>
                </div>
