...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Login | SUNU Assurances</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="HSE SECURITY - Login" name="description" />
        <meta content="XSEL Services" name="author" />
        ...
        <link href="<?php echo base_url(); ?>assets/admin/pages/css/login-3.min.css" rel="stylesheet" type="text/css" />
...
<!--                <img src="<?php echo base_url(); ?>assets/admin/pages/img/logo-big.png" alt="" />-->
                <span id="text-logo"><span class="font-red-thunderbird">SUNU Assurances</span></span>
<!--            </a>-->
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo site_url('admin/login/connexion'); ?>" method="post">
                <h3 class="form-title">Espace d'administration</h3>
<!--
                <div class="alert alert-danger display-hide">
                    <button class="close" data-close="alert"></button>
                    <span> Veuillez fournir un identifiant de connexion ainsi qu'un mot de passe. </span>
                </div>
-->
                <?php
                if (isset($feedBack)) {
                ...
                <div class="alert alert-<?php echo $feedBack['type']; ?>">
                    <!--<i class="ti-alert"></i>--> <?php echo $feedBack['message']; ?>
                </div>
                <?php
                }
                ?>
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" autofocus="autofocus" placeholder="Identifiant de connexion" name="login" /> </div>
                </div>
                <div class="form-group">
...
<!--                        <input type="checkbox" name="remember" value="1" /> Rester connect&eacute;-->
<!--                        <span></span>-->
                    </label>
                    <button type="submit" class="btn green pull-right"> Me connecter <i class="fa fa-arrow-right"></i> </button>
                </div>
<!--
...
<!--
                <div class="forget-password">
                    ...
                    <p> rien de bien grave, cliquez
                        <a href="javascript:;" id="forget-password">ici</a> pour r&eacute;initialiser le mot de passe. </p>
                </div>
-->
<!--
...
<!--
            <form class="forget-form" action="index.html" method="post">
                ...
                <p> Veuillez entrer l'adresse mail associ&eacute;e &agrave; votre comptte. </p>
                <div class="form-group">
                    <div class="input-icon">
                ...
                <div class="form-actions">
                    <button type="button" id="back-btn" class="btn grey-salsa btn-outline"> Retour </button>
                    <button type="submit" class="btn green pull-right"> R&eacute;initialiser </button>
                </div>
            </form>
-->
