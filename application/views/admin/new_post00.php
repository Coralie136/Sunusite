        ...
        <div class="col-md-12">
            ...
            <div class="portlet box <?php echo $color; ?>">
                ...
                <div class="portlet-body"><br />
                    ...
                    <!-- BEGIN FORM -->
                    <form method="POST" action="<?php echo site_url('post/addPost'); ?>" name="form_add" id="form_add" enctype="multipart/form-data">
                                    ...
                                    <div class="fileinput fileinput-new tooltips" title="Fichier .pdf uniquement" data-provides="fileinput">
                                        <span class="btn green-jungle btn-file">
                                            <span class="fileinput-new">
                                                Document &nbsp;<i class="fa fa-download"></i>
                                            </span>
                                            <span class="fileinput-exists"> Modifier </span>
                                            <input type="file" name="import-file" id="import-file" onchange="importDetail()" <?php echo $required; ?> value="" />
                                        </span>
                                    </div>
                                </div>
                                <div class="col-md-10">
                        ...
                        <div class="form-actions">
                            <div class="row text-right">
                                <div class="col-md-offset-9 col-md-3">
                                    <a href="<?php echo site_url('post'); ?>" class="btn btn-outline <?php echo $color; ?>"><i class="fa fa-long-arrow-left"></i> Annuler </a>
