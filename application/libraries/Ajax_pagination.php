...
class Ajax_pagination{
	...
	var $per_page	 		= 3; // Max number of items you want shown per page
	var $num_links			= 3; // Number of "digit" links to show before/after the currently viewed page
	var $cur_page	 		= 0; // The current page being viewed
	var $first_link   		= 'Premier';
	var $prev_link			= '<i class="fa fa-angle-left"></i>';
	var $next_link			= '<i class="fa fa-angle-right"></i>';
	var $last_link			= 'Dernier';
	var $uri_segment		= 4;
	var $full_tag_open		= '<div class="col-md-12 col-sm-12 col-xs-12"><div class="blog-pagination text-center"><ul class="pagination">';
	var $full_tag_close		= '</ul></div></div>';
	var $first_tag_open		= '';
	var $first_tag_close	= '&nbsp;';
	var $last_tag_open		= '&nbsp;';
	var $last_tag_close		= '';
	...
	var $next_tag_open		= '<li><a href="#">';
	var $next_tag_close		= '</a></li>';
	var $prev_tag_open		= '<li><a href="#">';
